...
\begin{algorithm}
    ...
    \begin{algorithmic}[1]
        ...
        \State $b_h \gets \Call{GetHeadBlock}$\Comment{Get chain tip}
        \State $b_w \gets \Call{GetLastPoWBlock}{b_h}$\Comment{Get latest PoW block on chain}
